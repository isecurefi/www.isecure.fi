  ...
  frontContent: {
    ...
    apiSection: {
      ...
      bankFiles: {
        ...
        description: {
          fi: "Palvelu synkronoi tiedostot pankista esim. SFTP palvelimellesi tai vaikkapa AWS S3 Bucket:iin säännöllisesti ja luotettavasti haluamansi ajankohtana. Selkeät raportit sekä lähetyksistä että vastaanotoista.",
          en: "The service synchronizes files from the bank to your SFTP server or AWS S3 Bucket regularly and reliably at your desired time. Clear reports for both sent and received files.",
          se: "Tjänsten synkroniserar filer från banken till din SFTP-server eller AWS S3 Bucket regelbundet och pålitligt vid önskad tidpunkt. Tydliga rapporter för både skickade och mottagna filer.",
        },
      },
      description: {
